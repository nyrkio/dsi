...
class FixtureFiles(object):
    ...
    def assert_json_files_equal(self, test_case, expect, actual):
        """
        Originally used json_diff, but as part of python3 migration just does a regular assertEqual.

        :param unittest.TestCase test_case: The test case to use.
        :param IO expect: expected json file path.
        :param IO actual: actual json file path.
        """
        ...
        test_case.assertEqual(result_perf_json, expected_perf_json)
